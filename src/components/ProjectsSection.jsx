...
export const ProjectsSection = () => {
  return (
    <section
      id="projects"
      className="py-16 px-4 sm:px-8 max-w-7xl mx-auto border-t border-[#262626]/50"
    >
      {/* Section Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
        <div>
          <div
            className="flex items-center gap-2 font-mono text-xs font-bold tracking-wider uppercase mb-2"
            ...
            >
              ...
              >
                ...
                <div className="-mt-4">
                  ...
                  <div
                    className="font-mono text-xs font-semibold tracking-wider mt-1.5 uppercase"
                    style={{ color: 'var(--accent)' }}
                  >
                    {project.categoryTags}
                  </div>
              ...
              >
                <div className="w-full aspect-[16/10] bg-[#121212] border border-[#262626] rounded-2xl overflow-hidden relative group cursor-pointer hover:border-[var(--accent)] transition-all duration-300 shadow-xl hover:shadow-2xl">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pointer-events-none">
                    <span
                      className="px-4 py-2.5 bg-black/80 backdrop-blur-md font-mono text-xs font-bold rounded-xl flex items-center gap-2 shadow-2xl group-hover:scale-105 transition-transform"
                      style={{
